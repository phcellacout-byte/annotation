...
return [
    ...
    | pela classe de validação. Algumas regras possuem múltiplas versões,
    | como as regras de tamanho. Sinta-se à vontade para ajustar cada uma
    | dessas mensagens conforme necessário.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute foi encontrado em um vazamento de dados. Escolha outro :attribute.',
    ],
